...
def search_model(trial: optuna.trial.Trial) -> List[Any]:
    ...
    m2_args = []
    m2_sub_args = []
    m2_out_channel = trial.suggest_int("m2/out_channels", low=global_output_channel, high=64, step=16)
    m2_stride = 2
    ...
    # Module2의 따까리
    model.append([m2_repeat, m2, m2_sub_args])
    ...
    if m4 == "Conv":
        ...
        m4_sub_args = [m4_out_channel, m4_kernel, 1, None, 1, m4_activation]
    elif m4 == "DWConv":
        # DWConv args: [out_channel, kernel_size, stride, padding_size, activation]
